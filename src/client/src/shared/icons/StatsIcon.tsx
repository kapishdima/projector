  ...
  return (
    <svg
      ...
      <path
        ...
        fill={fill || ICON_FILL}
      />
      <path d="M6,20a1,1,0,0,0,1-1V12a1,1,0,0,0-2,0v7A1,1,0,0,0,6,20Z" fill={fill || ICON_FILL} />
      <path d="M10,10v9a1,1,0,0,0,2,0V10a1,1,0,0,0-2,0Z" fill={fill || ICON_FILL} />
      <path d="M15,13v6a1,1,0,0,0,2,0V13a1,1,0,0,0-2,0Z" fill={fill || ICON_FILL} />
      <path d="M20,9V19a1,1,0,0,0,2,0V9a1,1,0,0,0-2,0Z" fill={fill || ICON_FILL} />
      <path
